...
<script>
  ...
  $(document).ready(function () {
    ...
    $idInput.on('keyup', e => {
      ...
      // test메서드는 정규표현식을 검증하여 정규표현식과 일치하면 true
      // 일치하지 않으면 false를 리턴
        ...
        fetch('/check?kind=account&info=' + $idInput.val())
          ...
          .then(flag => {
            if (flag === 'true') {
              ...
              $('#idChk').html('<b style="font-size:14px; color:red;">[사용가능한 아이디입니다.]</b>');
              chk1 = true;
            }
          })
      }
        ...
        fetch('/check?kind=email&info=' + $emailInput.val())
          ...
          .then(flag => {
            if (flag === 'true') {
              ...
              $('#emailChk').html('<b style="font-size:14px; color:red;">[이메일이 중복되었습니다.]</b>');
              chk5 = false;
            } else {
              $emailInput.css('background', 'aqua');
              $('#emailChk').html('<b style="font-size:14px; color:red;">[사용가능한 이메일입니다.]</b>');
              chk5 = true;
            }
          })
      }
