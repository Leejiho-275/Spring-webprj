                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <c:forEach var="board" items="${list}">
                        <tr>
                            ...
                            <td>
                                <a class='move'
                                    href="/board/get${pageInfo.makeParam(pageInfo.cri.page)}&bno=${board.bno}">
                                    ${board.title}
                                </a>
                            </td>
                    ...
                    <div class="col-lg-12">
                        ...
                        <form id='searchForm' action="/board/list" method='get'>
                            <select name='type'>
                                ...
                                <option value="titleContent" ${pageInfo.cri.type=='titleContent' ? 'selected' : '' }>>제목
                                    or 내용</option>
                            </select>
                ...
                <div class="pull-right">
                    <ul class="pagination">
                        ...
                        <c:forEach var="num" begin="${pageInfo.startPage}" end="${pageInfo.endPage}">
                            <li class="pagenate_button"><a href="/board/list${pageInfo.makeParam(num)}">${num}</a></li>
                        </c:forEach>
...
<script>
    $(document).ready(function () {
        ...
        function appendPageActive(currentPage) {
            const $pageLiList = document.querySelectorAll('.pagenate_button');
